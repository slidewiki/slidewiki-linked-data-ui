            ...
            <div className="ui fluid container" ref="defaultNavbar">
                <nav  className={'ui menu inverted navbar grid ' + navbarColor}>
                    <NavLink routeName="home" className="brand item" href='/'>
                        {this.props.loading ? <img src="/assets/img/loader.gif" alt="loading..." style={{height: 30, width: 30}} /> : <img style={{height: 22}} className="ui image" src="/assets/img/slideWiki-logo-linear.png" alt="ld-reactor" />}
                    </NavLink>
                    <NavLink className="item" href='/'> {appShortTitle} </NavLink>
