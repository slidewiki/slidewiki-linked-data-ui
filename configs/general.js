export default {
    //full page title
    appFullTitle: ['SlideWiki Linked Data Interface'],
    //short page title
    appShortTitle: ['Linked Data UI'],
    ...
    authDatasetURI: ['http://rdf.slidewiki.org/users'],
    ...
    baseResourceDomain: ['http://rdf.slidewiki.org'],
    ...
    configDatasetURI: ['http://rdf.slidewiki.org/configurations'],
    ...
    mappingsDatasetURI: ['http://rdf.slidewiki.org/mappings']
};
